...
namespace Goldmint.WebApplication.Core.Response {
	...
	public class APIResponse : Microsoft.AspNetCore.Mvc.ObjectResult {
		...
		/// </summary>
		public static APIResponse BadRequest(IEnumerable<Models.API.BaseValidableModel.Error> errorFields, string format = null, params object[] args) {
		...
		public static APIResponse BadRequest(string errorField, string errorDescription, string format = null, params object[] args) {
			return BadRequest(
				new[] { new Models.API.BaseValidableModel.Error() {
					Field = errorField,
