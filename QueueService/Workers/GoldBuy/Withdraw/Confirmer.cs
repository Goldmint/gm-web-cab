...
namespace Goldmint.QueueService.Workers.GoldBuy.Withdraw {

	// Confirmer receives events from mint-sender service, completing GOLD emission request
	public sealed class Confirmer : BaseWorker {

		private ApplicationDbContext _dbContext;
		private IConnection _conn;

		public Confirmer(BaseOptions opts) : base(opts) {
		}
		...
		private void HandleMessage(object _, MsgHandlerEventArgs args) {
			try {
				...
				if (req.Service != "core_gold_withdrawer") {
					return;
				}
