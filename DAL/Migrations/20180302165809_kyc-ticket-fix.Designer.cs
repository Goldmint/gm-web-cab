...
namespace Goldmint.DAL.Migrations
{
    ...
    [Migration("20180302165809_kyc-ticket-fix")]
    partial class kycticketfix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.UserVerification", b =>
                {
                    ...
                    b.Property<long?>("KycVerifiedTicketId")
                        .HasColumnName("verified_kyc_ticket_id");
                    ...
                    b.HasIndex("KycVerifiedTicketId");
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.UserVerification", b =>
                {
                    b.HasOne("Goldmint.DAL.Models.KycTicket", "KycLastTicket")
                        .WithMany()
                        .HasForeignKey("KycLastTicketId");

                    b.HasOne("Goldmint.DAL.Models.KycTicket", "KycVerifiedTicket")
                        .WithMany()
                        .HasForeignKey("KycVerifiedTicketId");
