...
namespace Goldmint.DAL.Migrations
{
    ...
    [Migration("20171120222141_initial-fix")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.ASP.Role", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.ASP.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.ASP.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.ASP.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.ASP.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.ASP.UserRole", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.ASP.UserToken", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.ASP.RoleClaim", b =>
                {
                    b.HasOne("Goldmint.DAL.Models.ASP.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.ASP.UserClaim", b =>
                {
                    b.HasOne("Goldmint.DAL.Models.ASP.User")
                        .WithMany()
            ...
            modelBuilder.Entity("Goldmint.DAL.Models.KycShuftiProTicket", b =>
                {
                    b.HasOne("Goldmint.DAL.Models.ASP.User", "User")
