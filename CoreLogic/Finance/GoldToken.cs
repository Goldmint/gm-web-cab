...
namespace Goldmint.CoreLogic.Finance {
	...
	public static class GoldToken {
		...
		/// <summary>
		/// Process contract GOLD selling request (core)
		/// GOLD burnt in Sumus, ETH/fiat will be sent
		/// </summary>
		/*public static async Task<BuySellRequestProcessingResult> OnSumusGoldBurnEvent(IServiceProvider services, BigInteger requestIndex, long internalRequestId, string address, BigInteger amountGold, string txId, int txConfirmationsRequired) {
			...
			var query =
				...
				where
					r.Input == SellGoldRequestInput.SumusGoldBurning &&
