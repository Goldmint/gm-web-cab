...
namespace Goldmint.CoreLogic.Services.Oplog {
	...
	public interface IOplogProvider {
		...
		Task<string> NewGoldBuyingRequestForCryptoasset(long userId, EthereumToken ethereumToken, string destAddress, FiatCurrency fiatCurrency, long inputRate, long goldRate);
