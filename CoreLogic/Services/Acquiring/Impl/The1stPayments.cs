...
namespace Goldmint.CoreLogic.Services.Acquiring.Impl {

	public sealed partial class The1stPayments : ICardAcquirer {
		...
		public async Task<StartCardStoreResult> StartPaymentCardStore(StartPaymentCardStore data) {
			...
			try {
				...
				// validate
				{
					...
					v.RuleFor(_ => _.RedirectUrl).Must(ValidationRules.BeValidDectaRedirectUrl);
